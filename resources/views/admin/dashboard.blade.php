  ...
  <section class="bg-white text-gray-600 body-font">
    <div class="container px-5 py-24 mx-auto">
      <div class="flex flex-col text-center w-full mb-20">
        ...
        <p class="lg:w-2/3 mx-auto leading-relaxed text-base">管理画面</p>
      </div>
      <div class="lg:w-2/3 w-full mx-auto overflow-auto">
        <div class="flex items-end gap-3 mb-4 px-4">
          <span class="sm:text-2xl text-xl font-medium text-gray-900">お知らせ</span>
          <span class="sm:text-lg text-base text-gray-500 tracking-widest">information</span>
        </div>        
          ...
          <tbody class="mt-4">
            <tr>
              ...
              <td class="border-t-2 px-4 py-3 text-lg text-gray-900">
                <a href="{{ route('admin.information.index') }}" class="text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">一覧ページへ移動</a>
              </td>
            </tr>
            <tr>
              ...
              <td class="border-t-2 border-b-2 px-4 py-3 text-lg text-gray-900">
                <a href="{{ route('admin.information.create') }}" class="text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">作成ページへ移動</a>
              </td>
            </tr>
          </tbody>
        </table>

        ...
        <div class="p-4 md:w-1/3 sm:w-1/2 w-full mb-6">
          <div class="relative rounded-lg overflow-hidden bg-white">
            ...
            <div class="mt-4">
              ...
              <div class="mt-4">
                @if($product->is_sold_out)
                  <a href="{{ route('admin.products.show', $product->id) }}" class="inline-block bg-gray-300 text-gray-500 px-6 py-2 rounded-full hover:bg-gray-400 text-sm">
                    詳しく見る
                  {{-- <span class="inline-block bg-gray-300 text-gray-500 px-6 py-2 rounded-full text-sm cursor-not-allowed"> --}}
                  </a>
                @else
                  <a href="{{ route('admin.products.show', $product->id) }}" class="inline-block bg-yellow-500 text-gray-700 font-bold px-6 py-2 rounded-full hover:bg-yellow-400 text-sm">
                    詳しく見る
                  </a>
                @endif
              </div>
              <div class="p-2 w-full flex justify-around mt-4">
                <a href="{{ route('admin.products.edit', $product->id) }}" class="text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">編集</a>

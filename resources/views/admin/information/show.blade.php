      ...
      <div class="text-center lg:w-2/3 w-full">
        <p class="mb-8 leading-relaxed">{{ $information->description }}</p>
          <div class="p-2 w-full flex justify-around mt-4">
            <button type="button" onclick="location.href='{{ route('admin.information.index')}}'" class="bg-gray-200 border-0 py-2 px-8 focus:outline-none hover:bg-gray-400 rounded text-lg">お知らせ一覧へ戻る</button>
          </div>
      </div>
    </div>
  </section>

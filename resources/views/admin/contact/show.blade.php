    ...
    <div class="container px-5 py-24 mx-auto">
      ...
      <div class="bg-white shadow rounded-lg p-6">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          {{-- お問い合わせ種別 --}}
          <div>
            <p class="text-sm text-gray-500 mb-1">お問い合わせ種別</p>
          ...
          {{-- 会社名 --}}
          <div>
            <p class="text-sm text-gray-500 mb-1">会社名</p>
            <div class="bg-gray-100 border rounded px-3 py-2">
              {{ $contact->name ?: '―' }}
            </div>
          </div>
          ...
          {{-- フリガナ --}}
          <div>
            <p class="text-sm text-gray-500 mb-1">フリガナ</p>
            <div class="bg-gray-100 border rounded px-3 py-2">
          ...
          {{-- お問い合わせ内容 --}}
          <div class="md:col-span-2">
            <p class="text-sm text-gray-500 mb-1">お問い合わせ内容</p>
            <div class="bg-gray-100 border rounded px-3 py-3 whitespace-pre-wrap">{{ e(trim($contact->message)) }}</div>
          </div>
          {{-- 送信日時 --}}
          <div>
            <p class="text-sm text-gray-500 mb-1">送信日時</p>
            <div class="bg-gray-100 border rounded px-3 py-2">
